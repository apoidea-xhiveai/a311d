...
typedef struct {
    ...
    xHiveAiPicFmt_t pic_t;  /*XHAI_PIC_jpeg(default)*/
    int             pic_w;  /*0(default): original picture size*/
    int             pic_h;  /*0(default): original picture size*/

    int             en_ai_result; /* >0: report out the AI analysis results
                                      0: don't report */
} xHiveAiConfig_Mqtt_t;
...
#define XHAI_MQTT_FACE_DETECT  "xhai_mqtt_face_detect"
#define XHAI_MQTT_FACE_RECOG   "xhai_mqtt_face_recog"
