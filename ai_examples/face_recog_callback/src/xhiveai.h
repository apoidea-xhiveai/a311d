...
typedef enum xHiveAiConfig_t {
    ...
    xHiveAiConfig_StartUnused          = 0x01000000,
    xHiveAiConfig_Mqtt,                /**< reference: xHiveAiConfig_Mqtt_t */

    xHiveAiConfig_Max                  = 0x7FFFFFFF
} xHiveAiConfig_t;

typedef enum xHiveAiParam_t {

    xHiveAiParam_StartUnused          = 0x01000000,

    xHiveAiParam_Max                  = 0x7FFFFFFF
} xHiveAiParam_t;
